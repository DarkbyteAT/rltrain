...
from spike.buffer import make_buffer
from spike.trainer._carry import TrainCarry, TrainConfig


if TYPE_CHECKING:
    from spike.trainer._loops import TrainingLoop
    ...
    def __init__(
        ...
        *,
        ...
        if loop is not None:
            ...
            from spike.trainer._loops import ScanLoop

            self._loop = ScanLoop()
        else:
            from spike.trainer._loops import PythonLoop
